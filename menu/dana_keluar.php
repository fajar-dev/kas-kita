                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: right;">
                          ...
                          <td>
                             <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="hapus_keluar.php?id=<?php echo $data['id'];?>" class="btn btn-danger btn-md" title="Hapus Data"><i class="fa fa-trash"> </i></a>
                                            </td>
                      </tr>
                       <?php 
